        ...
        <ul class="list-unstyled">
          ...
          >
            <RouterLink class="sidebar-link" to="/admin/user">
              <i
                class="fa fa-user svg-icon svg-icon-sm svg-icon-heavy"
          ...
          >
            <RouterLink class="sidebar-link" to="/admin/transaction">
              <i
                class="fa fa-database svg-icon svg-icon-sm svg-icon-heavy"
                style="font-size: 24px"
              ></i>
          ...
          >
            <RouterLink class="sidebar-link" to="/admin/leads">
              <i
                class="fa fa-comment svg-icon svg-icon-sm svg-icon-heavy"
                style="font-size: 24px"
              >
              </i
